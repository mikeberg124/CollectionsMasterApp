...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // print out your numbers from arrays or lists
            //NumberPrinter();
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Yes, the number is on the list");
            }
            else
            {
                Console.WriteLine($"The number you put is not on the list");
            }
        }
